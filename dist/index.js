...
var nonAuthorisedEndpoints = ["/", "/login", "/captcha", "/auth", "/test-auth-status"];
app.use(helmet({
...
app.post("/auth", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var username, password, statusText, validated, unique, status;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 7;
          return auth.isUniqueUsername(username);
        case 7:
          unique = _context.sent;
          if (!(unique == 1)) {
            _context.next = 13;
            break;
          }
...
app.post("/register", /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var username, password, validated, status, sqlStatus;
...
app.get("/test-auth-status", function (req, res) {
  try {
